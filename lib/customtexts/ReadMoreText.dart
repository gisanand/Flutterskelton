...
class ReadMoreTextState extends State<ReadMoreText> {
  ...
  Widget build(BuildContext context) {
    ...
    var effectiveTextStyle=getStyeloftext(widget.familytype!, widget.textsize!, widget.textcolor!);
  ...
  TextStyle getStyeloftext(int familytype,double textsize,Color textcolor)
  {
    TextStyle tstyle =
    ...
    if (familytype == 1) {
      ...
      tstyle =
          TextStyle(fontFamily: 'SemiBold', fontSize: textsize, color: textcolor);
    }
  return tstyle;
  }
}