...
class AwesomeDropDown<T> extends StatefulWidget {
  ...
  final List<AwsomeMenuListItem> dropDownList;
  ...
  AwesomeDropDown({
    ...
    this.dropDownBottomBorderRadius: 5,
    this.dropDownTopBorderRadius: 5,
    this.selectedItem: '',
    this.selectedItemTextStyle: const TextStyle(
        color: Colors.black, fontSize: 16, fontWeight: FontWeight.normal),
    this.dropDownListTextStyle: const TextStyle(
        color: Colors.black, fontSize: 15, backgroundColor: Colors.transparent),
    this.elevation: 5,
    this.padding: 8,
...
class _AwesomeDropDownState extends State<AwesomeDropDown>
  ...
  void findDropdownData() {
    ...
    print(" the height of the render box is : ${renderBox.size.height}");
  ...
  OverlayEntry? _createFloatingDropdown(int numOfListItemToShow) {
    int numOfListItem = numOfListItemToShow != null &&
        ...
        ? numOfListItemToShow
        : 4;
    print("no of list item is  :${numOfListItem} and no of list item is to show is : ${numOfListItemToShow} and drop down length is : ${widget.dropDownList.length}");

    double overlayHeight = _listItemHeight * widget.dropDownList.length + 15,
        fourItemsHeight = numOfListItem * _listItemHeight + 15;
    if(widget.dropDownList.length <1){
      /// when the list is empty it will be executed ..
      print("no data found in it");
    ...
    return OverlayEntry(builder: (context) {
      print(" the value of list item height is : ${_listItemHeight} and overlay height is : ${overlayHeight} and four items height is : ${fourItemsHeight}");
      return Positioned(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      x.name,
                                        ...
                                        textScaleFactor: MediaQuery.of(context).textScaleFactor >1.5 ? 1.5
                                            : MediaQuery.of(context).textScaleFactor,
...
class AwsomeMenuListItem {
  String name;
  String id;

  AwsomeMenuListItem(this.id, this.name);
}