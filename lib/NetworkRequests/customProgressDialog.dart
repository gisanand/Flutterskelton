    ...
    if (_isShowing) {
      try {
        ...
        if (Navigator.of(_dismissingContext).canPop()) {
          ...
          if (_showLogs) debugPrint('customProgressDialog dismissed');
        } else {
          if (_showLogs) debugPrint('Cant pop customProgressDialog');
        }
      } catch (_) {}
    } else {
      if (_showLogs) debugPrint('customProgressDialog already dismissed');
    }
  }
  ...
  Future<bool> show() async {
    if (!_isShowing) {
      try {
        ...
        if (_showLogs) debugPrint('customProgressDialog shown');
        _isShowing = true;
        return true;
      } catch (_) {
        return false;
      ...
      if (_showLogs) debugPrint("customProgressDialog already shown/showing");
      return false;
    }
  }
}
...
class _BodyState extends State<_Body> {
  ...
  void dispose() {
    _isShowing = false;
    if (_showLogs) debugPrint('customProgressDialog dismissed by back button');
    super.dispose();
  }
