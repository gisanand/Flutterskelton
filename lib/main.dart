...
import 'package:flutterapiapp/network/EndPoints.dart';
...
class _MyHomePageState extends State<MyHomePage> implements Apicallback {
  int _counter = 0;
  ...
  void _incrementCounter(BuildContext context) {
    ...
    Apicall(context,this,url,1,request,1,true,true,101);
    setState(() {
  ...
  void SuccessResponse(String response, int statuscode) {
    developer.log('log me', name: 'my.app.category $response');
